...
import { logsDownload, teamBehavior, teamContribute } from "~/api/modules/bvi";
  ...
  const columns: TableColumn[] = [
    {
      ...
      render: ({ current, Clipboard }) => (
        ...
        >
          ...
          <Clipboard>{formatAddress(current, isMobile ? 6 : 0)}</Clipboard>
        </Flex>
      ),
    },
    {
