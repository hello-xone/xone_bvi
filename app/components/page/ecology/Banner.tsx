    ...
    <Flex direction="column" className="max-w-full">
      <Box pos="relative" overflow="hidden">
        ...
        <Flex
          ...
          pr={{ base: "22px", md: "150px", xl: "150px", "2xl": "620px" }}
          pt={{ base: "41px", md: 0 }}
        >
          <Box
          ...
          >
            {t(
              "A top-level DApp built on the Xone Chain ecosystem, exploring infinite possibilities and driving cutting-edge innovation."
            )}
          </Box>
        </Flex>
      </Box>
