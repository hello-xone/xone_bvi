...
import { CONTRACT_ADDRESSES, BLOCK_EXPLORER } from "~/config/env";
...
export const convertToUTC = (
  date: any,
  timezone?: string,
  format = "YYYY-MM-DD HH:ss:ss"
) => {
  if (!date) return "";
  const zonedDate = dayjs(date).tz(timezone, false);
      ...
      >
        ...
        <Wrap alignItems="center" gapX="18px" mt={{ base: "10px", md: "20px" }}>
          ...
          <ExternalLink
            ...
            fontSize="14px"
            fontWeight="400"
            to={`${BLOCK_EXPLORER}/address/${
              CONTRACT_ADDRESSES.XOC_RELEASE
            }`}
          >
            <Flex display="inline-flex" gap="6px" alignItems="center">
              ...
              <Text display={{ base: "block", md: "none" }}>
                {formatAddress(CONTRACT_ADDRESSES.XOC_RELEASE)}
              </Text>
