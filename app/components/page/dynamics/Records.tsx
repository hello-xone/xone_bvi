      ...
      >
        ...
        <Wrap alignItems="center" gapX="18px" mt={{ base: "10px", md: "20px" }}>
          ...
          <ExternalLink
            ...
            }/address/0xd77aFA297F044CB3F2c0bF6d3cDB149811863059`}
          >
        ...
        <Wrap alignItems="center" mt="5" gap={{ base: "10px", md: "16px" }}>
          <Box
            w={{ base: "100%", md: "auto" }}
          ...
          <SearchInput
            ...
            w={{ base: "100%", md: "320px" }}
            maxW={{ base: "calc(100% - 110px)", md: "320px" }}
            ml={{ base: 0, md: "auto" }}
            value={inputValue}
