...
export default function Banner() {
  ...
  const settings = {
    ...
    arrows: false,
    dotsClass:
      "!flex justify-center gap-[19px] mt-[10px] text-[0] [&>li>button]:w-[40px] [&>li>button]:h-[4px] [&>li]:rounded-[8px] [&>li]:bg-[#C6C6C6] [&>.slick-active]:bg-[#FF0206] [&>.slick-active>button]:w-[56px] [&>li>button]:transition-all [&>li]:transition-all",
  };
  return (
    <Box
      maxW="full"
